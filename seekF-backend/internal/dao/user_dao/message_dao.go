...
type MessageDAO interface {
	GetMessageList(userOneId string, userTwoId string) ([]models.Message, error)
}
...
func (d *MessageDAOImpl) GetMessageList(userOneId string, userTwoId string) ([]models.Message, error) {
